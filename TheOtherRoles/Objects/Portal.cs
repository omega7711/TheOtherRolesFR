...
namespace TheOtherRoles.Objects {
    ...
    public class Portal {
        ...
        public static void startTeleport(byte playerId) {
            ...
            string playerNameDisplay = Portalmaker.logOnlyHasColors ? "Un joueur (" + (Helpers.isLighterColor(playerControl.Data.DefaultOutfit.ColorId) ? "C" : "F") + ")" : playerControl.Data.PlayerName;

            int colorId = playerControl.Data.DefaultOutfit.ColorId;

            if (Camouflager.camouflageTimer > 0) {
                playerNameDisplay = "Joueur camouflé";
                colorId = 6;
            }
