...
namespace TheOtherRoles
{
    ...
    public class TheOtherRolesPlugin : BasePlugin
    {
        ...
        public override void Load() {
            ...
            GhostsSeeVotes = Config.Bind("Custom", "Les fantômes peuvent voir les votes", true);
            ShowRoleSummary = Config.Bind("Custom", "Résumé des rôles", true);
            ShowLighterDarker = Config.Bind("Custom", "Sombre / Clair", true);
            EnableSoundEffects = Config.Bind("Custom", "Active les Effets de son", true);
            EnableHorseMode = Config.Bind("Custom", "Active le mode Horse", false);
            ShowPopUpVersion = Config.Bind("Custom", "Montre des PopUp", "0");
            

            Ip = Config.Bind("Custom", "Ip du serveur Personnalisé", "127.0.0.1");
            Port = Config.Bind("Custom", "Port du Serveur Personnalisé", (ushort)22023);
