    ...
    public class CustomColors {
        ...
        public static void Load() {
            ...
            colors.Add(new CustomColor { longname = "Saumon",
                                        ...
                                        isLighterColor = true });
            colors.Add(new CustomColor { longname = "Rouge foncé",
            ...
            colors.Add(new CustomColor { longname = "Wasabi",
                                        ...
                                        isLighterColor = false });
            colors.Add(new CustomColor { longname = "Rose Chaud",
