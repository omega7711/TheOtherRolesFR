    ...
    public static class RPCProcedure {
        ...
        public static void lightsOut() {
            ...
            if(CachedPlayer.LocalPlayer.Data.Role.IsImpostor) {
                new CustomMessage("Les lumières sont désactivées ", Trickster.lightsOutDuration);
            }
        }
        ...
        public static void guesserShoot(byte killerId, byte dyingTargetId, byte guessedTargetId, byte guessedRoleId) {
            ...
            if (Guesser.showInfoInGhostChat && CachedPlayer.LocalPlayer.Data.IsDead && guessedTarget != null) {
                ...
                string msg = $"le Devin a deviné le rôle {roleInfo?.name ?? ""} pour {guessedTarget.Data.PlayerName}!";
