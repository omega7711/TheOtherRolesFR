    ...
    class MeetingHudPatch {
        ...
        static void swapperOnClick(int i, MeetingHud __instance) {
            ...
            if (selectedCount == 0) {
                ...
                if (selections[i]) {
                    ...
                    selections[i] = true;
                    renderer.color = Color.yellow;
                    swapperConfirmButtonLabel.text = Helpers.cs(Color.yellow, "Confirmer L'échange");
                }
            } else if (selectedCount == 2) {
                if (selections[i]) {
                    renderer.color = Color.red;
                    selections[i] = false;
                    swapperConfirmButtonLabel.text = Helpers.cs(Color.red, "Confirmer L'échange");
                }
            }
        }
        ...
        static void swapperConfirm(MeetingHud __instance) {
            ...
            if (firstPlayer != null && secondPlayer != null) {
                ...
                swapperConfirmButtonLabel.text = Helpers.cs(Color.green, "Echange!");
                Swapper.charges--;
        ...
        static void populateButtonsPostfix(MeetingHud __instance) {
            ...
            if (Swapper.swapper != null && CachedPlayer.LocalPlayer.PlayerControl == Swapper.swapper && !Swapper.swapper.Data.IsDead) {
                ...
                swapperChargesText.text = $"Echanges: {Swapper.charges}";
            ...
            public static void Prefix(PlayerControl __instance, [HarmonyArgument(0)]GameData.PlayerInfo meetingTarget) {
                ...
                if (Portalmaker.portalmaker != null && CachedPlayer.LocalPlayer.PlayerControl == Portalmaker.portalmaker && !CachedPlayer.LocalPlayer.Data.IsDead) {
                    foreach (var entry in Portal.teleportedPlayers) {
                        ...
                        string msg = Portalmaker.logShowsTime ? $"Il y a {(int)timeBeforeMeeting}s: " : "";
