    ...
    class EmergencyMinigameUpdatePatch {
        static void Postfix(EmergencyMinigame __instance) {
            ...
            if (Swapper.swapper != null && Swapper.swapper == CachedPlayer.LocalPlayer.PlayerControl && !Swapper.canCallEmergency) {
                ...
                statusText = "Le swapeur ne peut pas faire un meeting d'urgence";
            }
            ...
            if (__instance.state == 1) {
                ...
                __instance.NumberText.text = $"{localRemaining.ToString()} et le vaisseau a {teamRemaining.ToString()}";
