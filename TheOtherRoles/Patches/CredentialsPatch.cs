...
$@"Moddé par <color=#FCCE03FF>Eisbison</color>, <color=#FCCE03FF>Thunderstorm584</color>, <color=#FCCE03FF>EndOfFile</color> & <color=#FCCE03FF>Mallöris</color>
Design de <color=#FCCE03FF>Bavari</color>";

        public static string contributorsCredentials =
$@"<size=60%> <color=#FCCE03FF>Remerciements à K3ndo, Smeggy & à omega7711(traduction)</color></size>";
        ...
        internal static class PingTrackerPatch
        {
            ...
            static void Postfix(PingTracker __instance){
                ...
                if (AmongUsClient.Instance.GameState == InnerNet.InnerNetClient.GameStates.Started) {
                    __instance.text.text = $"<size=130%><color=#ff351f>TheOtherRoles FR</color></size> v{TheOtherRolesPlugin.Version.ToString()}\n" + __instance.text.text;
